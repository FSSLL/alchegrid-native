...
export const CARD_ASPECT = 977 / 1019;         // exact image ratio (≈ 0.96, nearly square)
...
export const ELEMENT_PNGS: Record<string, ReturnType<typeof require>> = {
  ...
  // ── World 4 – Chemistry Lab (base elements) ──────────────────────────────────
  acid:              require('../assets/images/w4_acid.png'),
  base:              require('../assets/images/w4_base.png'),
  carbon:            require('../assets/images/w4_carbon.png'),
  gas:               require('../assets/images/w4_gas.png'),
  heat:              require('../assets/images/w4_heat.png'),

  // World 4 – recipe combos
  'acid cloud':      require('../assets/images/w4_acid_cloud.png'),
  aerosol:           require('../assets/images/w4_aerosol.png'),
  alkali:            require('../assets/images/w4_alkali.png'),
  alloy:             require('../assets/images/w4_alloy.png'),
  antidote:          require('../assets/images/w4_antidote.png'),
  'arc plasma':      require('../assets/images/w4_arc_plasma.png'),
  blaze:             require('../assets/images/w4_blaze.png'),
  blight:            require('../assets/images/w4_blight.png'),
  brine:             require('../assets/images/w4_brine.png'),
  calciner:          require('../assets/images/w4_calciner.png'),
  calcium:           require('../assets/images/w4_calcium.png'),
  cement:            require('../assets/images/w4_cement.png'),
  char:              require('../assets/images/w4_char.png'),
  cinder:            require('../assets/images/w4_cinder.png'),
  cloud:             require('../assets/images/w4_cloud.png'),
  coal:              require('../assets/images/w4_coal.png'),
  compound:          require('../assets/images/w4_compound.png'),
  converter:         require('../assets/images/w4_converter.png'),
  corrosion:         require('../assets/images/w4_corrosion.png'),
  crucible:          require('../assets/images/w4_crucible.png'),
  deposit:           require('../assets/images/w4_deposit.png'),
  dross:             require('../assets/images/w4_dross.png'),
  etch:              require('../assets/images/w4_etch.png'),
  foam:              require('../assets/images/w4_foam.png'),
  fumarate:          require('../assets/images/w4_fumarate.png'),
  formula:           require('../assets/images/w4_formula.png'),
  fume:              require('../assets/images/w4_fume.png'),
  graphite:          require('../assets/images/w4_graphite.png'),
  haze:              require('../assets/images/w4_haze.png'),
  ingot:             require('../assets/images/w4_ingot.png'),
  ink:               require('../assets/images/w4_ink.png'),
  limestone:         require('../assets/images/w4_limestone.png'),
  lotion:            require('../assets/images/w4_lotion.png'),
  mixture:           require('../assets/images/w4_mixture.png'),
  oxide:             require('../assets/images/w4_oxide.png'),
  patina:            require('../assets/images/w4_patina.png'),
  pigment:           require('../assets/images/w4_pigment.png'),
  potion:            require('../assets/images/w4_potion.png'),
  quench:            require('../assets/images/w4_quench.png'),
  reagent:           require('../assets/images/w4_reagent.png'),
  resin:             require('../assets/images/w4_resin.png'),
  rinse:             require('../assets/images/w4_rinse.png'),
  rocket:            require('../assets/images/w4_rocket.png'),
  rust:              require('../assets/images/w4_rust.png'),
  salt:              require('../assets/images/w4_salt.png'),
  slurry:            require('../assets/images/w4_slurry.png'),
  smelt:             require('../assets/images/w4_smelt.png'),
  smog:              require('../assets/images/w4_smog.png'),
  solution:          require('../assets/images/w4_solution.png'),
  solvent:           require('../assets/images/w4_solvent.png'),
  spray:             require('../assets/images/w4_spray.png'),
  tarnish:           require('../assets/images/w4_tarnish.png'),
  tonic:             require('../assets/images/w4_tonic.png'),
  vapor:             require('../assets/images/w4_vapor.png'),
  vent:              require('../assets/images/w4_vent.png'),
  vinegar:           require('../assets/images/w4_vinegar.png'),
};
